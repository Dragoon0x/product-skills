---
id: landing-page-testing-discovery
name: Landing Page Testing Discovery
domain: ps-discovery
version: 1.0.0
---
# Landing Page Testing Discovery
**Purpose:** Apply landing page testing discovery — placeholder for expansion.
## When to use
