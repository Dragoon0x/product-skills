---
id: analyst-briefing-product
name: Analyst Briefing Product
domain: ps-communication
version: 1.0.0
---
# Analyst Briefing Product
**Purpose:** Apply analyst briefing product — placeholder for expansion.
## When to use
...
### Communication Patterns I've Seen Work

**The one-page rule:** Any product document that exceeds one page should be rewritten. The discipline of fitting a PRD, a strategy update, or a launch plan on one page forces clarity. Long documents indicate unclear thinking, not thorough thinking. If you need more space for details, put them in an appendix — the main document should be one page that captures the decisions and reasoning.

**The stakeholder communication secret:** Proactive communication prevents 90% of stakeholder friction. A weekly written update — same format, same day, same level of honesty — eliminates the anxiety that causes stakeholders to micromanage. The update doesn't need to be optimistic. It needs to be honest and predictable. Stakeholders can handle bad news. They can't handle surprises.

**The 'disagree and commit' protocol:** Not every decision will have consensus. The protocol: anyone can voice disagreement during the discussion. Once the decision is made (by the designated decision-maker), everyone commits to executing it fully — including those who disagreed. The commitment is real: no passive resistance, no 'I told you so' if it fails. This protocol enables fast decisions without requiring unanimity.

**The PM's writing investment:** Writing is the PM's primary tool. Invest in it. Write every day — PRDs, updates, narratives, even internal Slack messages deserve clear, concise writing. Read your writing aloud. If it sounds clunky, rewrite. If a sentence requires re-reading, simplify. The PM who writes clearly thinks clearly, and the team that receives clear writing executes with less ambiguity.
