---
id: product-cannibalization-management
name: Product Cannibalization Management
domain: ps-strategy
version: 1.0.0
---
# Product Cannibalization Management
**Purpose:** Apply product cannibalization management — placeholder for expansion.
## When to use
...
### Decision Patterns I've Seen Work
After hundreds of product strategy decisions, these patterns recur:

**The 80/20 of strategy:** 80% of strategic value comes from getting three things right: who you serve (ICP specificity), what problem you solve (problem clarity), and how you're different (positioning sharpness). Everything else — market timing, team capability, competitive dynamics — matters but matters less than these three.

**The best strategies are boring.** They don't require a 50-slide deck to explain. 'We're going to be the fastest issue tracker for engineering teams' is boring and brilliant. 'We're going to build an AI-powered collaborative knowledge management platform for the future of work' is exciting and meaningless. If the strategy sounds like a press release, it's not clear enough to execute.

**Strategy changes should be infrequent.** If you're changing strategy every quarter, you're not iterating — you're flailing. Strategy should change when the evidence overwhelmingly indicates the current direction is wrong. Execution should change constantly. The discipline is knowing which layer you're adjusting.

**The strategy meeting anti-pattern:** 3-hour meetings where everyone debates the strategy. Better: the PM writes the strategy as a 1-page narrative, shares it 48 hours before the meeting, and uses the meeting for Q&A and decisions — not for generation. The PM does the thinking. The team validates the thinking.

### Reading List for Strategy Depth
- *Obviously Awesome* by April Dunford (positioning)
- *Play Bigger* by Al Ramadan et al. (category design)
- *Good Strategy Bad Strategy* by Richard Rumelt (strategy craft)
- *The Mom Test* by Rob Fitzpatrick (customer discovery)
- *Crossing the Chasm* by Geoffrey Moore (market entry)
- *Inspired* by Marty Cagan (product leadership)
